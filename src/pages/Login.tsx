...
export default function Login() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-0">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-6 sm:p-8 text-center border border-gray-100 relative">
        <Link 
          to="/" 
          className="absolute top-4 left-4 sm:top-6 sm:left-6 text-gray-400 hover:text-gray-700 transition-colors flex items-center gap-1.5 text-sm font-medium"
        >
          <ArrowLeft size={16} />
          Kembali
        </Link>
        
        <div className="mx-auto bg-blue-100 text-blue-600 w-16 h-16 rounded-full flex items-center justify-center mb-6 mt-6 sm:mt-4">
          <Vote size={32} />
        </div>
